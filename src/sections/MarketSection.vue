  ...
  <section id="market" class="relative py-20 md:py-28 overflow-hidden">
    <div
      ...
      style="
        width: 560px;
        height: 560px;
        background: radial-gradient(circle, rgba(58, 77, 184, 0.16), transparent 70%);
        top: -100px;
        right: -120px;
        opacity: 0.4;
      "
    ...
    <div class="max-w-[1380px] mx-auto px-6 md:px-10 relative z-10">
      <div class="max-w-3xl mb-12">
        ...
        <h2
          ...
          data-reveal
        >
          A once-in-a-generation <span class="text-grad">climate economy.</span>
        </h2>
        <p class="text-graphite text-lg leading-relaxed mt-4" data-reveal>
          The method matters because the moment does — the market is moving on the same clock as the
          regulation.
        </p>
      </div>
      <div
        class="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-stone rounded-3xl overflow-hidden border border-stone mb-20"
      >
        <div class="bg-sand p-9 lg:p-10">
          <div
            class="font-display font-extrabold text-forest text-[clamp(2.8rem,5vw,4rem)] leading-none mb-3"
          >
            $<span class="counter" data-target="53">0</span>B
          </div>
        ...
        <div class="bg-sand p-9 lg:p-10">
          <div
            class="font-display font-extrabold text-forest text-[clamp(2.8rem,5vw,4rem)] leading-none mb-3"
          >
            $<span class="counter" data-target="7">0</span>T
          </div>
      ...
      <div class="grid lg:grid-cols-[0.7fr_1.3fr] gap-12 items-center">
        <div data-reveal>
          ...
          <h3 class="font-display font-bold text-charcoal text-2xl md:text-3xl mb-3">
            Green investment to 2030
          </h3>
          <p class="text-graphite leading-relaxed text-lg">
            The $7 trillion the world needs to invest by 2030 — shown as a trajectory.
          </p>
        </div>
        <div data-reveal>
          <svg
            ...
            class="w-full h-auto"
            role="img"
            aria-label="Green investment growth trajectory to 2030"
          >
            <defs>
              <linearGradient id="areaG" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stop-color="#2FA66A" stop-opacity="0.45" />
                <stop offset="100%" stop-color="#DDF5E5" stop-opacity="0.05" />
              </linearGradient>
            ...
            <path
              ...
              fill="url(#areaG)"
              style="opacity: 0"
              d="M40,250 L130,232 L220,205 L310,168 L400,122 L490,72 L560,40 L560,260 L40,260 Z"
            />
            <path
              class="chart-line"
              fill="none"
              ...
              style="stroke-dasharray: 1400; stroke-dashoffset: 1400"
              d="M40,250 L130,232 L220,205 L310,168 L400,122 L490,72 L560,40"
            />
