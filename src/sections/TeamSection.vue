  ...
  <section id="team" class="relative py-20 md:py-28 overflow-hidden">
    <div
      ...
      style="
        width: 520px;
        height: 520px;
        background: radial-gradient(circle, rgba(91, 227, 139, 0.12), transparent 70%);
        top: 10%;
        right: -160px;
      "
    ></div>
    <div class="max-w-[1380px] mx-auto px-6 md:px-10 relative z-10">
      <div class="max-w-3xl mb-10">
        ...
        <h2
          ...
          data-reveal
        >
          The people behind your <span class="text-grad">climate transition.</span>
        </h2>
        <p class="font-serif-q text-charcoal/75 text-xl leading-relaxed mb-5" data-reveal>
          Your engagement is led by specialists who have lived inside the problems they now solve —
          veterans of regulatory bodies, financial institutions, climate research, and technology.
        </p>
      </div>
      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5" data-reveal>
        ...
        >
          ...
          <div
            class="portrait-mono"
            :class="{ 'has-photo': member.photo && !member.photoError }"
            aria-hidden="true"
          >
            <span class="font-serif-q">{{ member.initials }}</span>
          </div>
          <div class="portrait-meta">
            <h3 class="font-display font-bold text-xl text-sand leading-tight">
              {{ member.name }}
            </h3>
            <p class="text-sm font-display font-medium mb-3" :style="`color:${member.roleColor}`">
              {{ member.role }}
            </p>
            <a
